...
class ProjectPolicy
{
    ...
    public function transition(User $user, Project $project, string $toStatus): bool
    {
        ...
        return match ($toStatus) {
            ...
            'under_review', 'draft', 'approved', 'completed' => $this->hasProgramRole($user, $project, User::ROLE_SUPERVISOR),
            'archived' => $this->hasProgramRole($user, $project, User::ROLE_COORDINATOR),
            default => false,
        };
    }
